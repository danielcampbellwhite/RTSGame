...
export default function ResourceBar() {
  ...
  return (
    <div className="panel glow-border flex items-center gap-1 px-3 py-2 text-xs">
      ...
      {RESOURCES.map((r) => (
        <div key={r.key} className="flex min-w-[64px] flex-col items-start border-l border-[var(--wd-border)] px-2">
